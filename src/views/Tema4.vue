...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul fnd-4- fnd-7")
      .row(titulo="Generalidades").justify-content-center.align-items-center
      ...
      .row(titulo="Tener en cuenta").justify-content-center.align-items-center
        .col-lg-7.mb-4.mb-md-0
      ...
      .row(titulo="Fuentes de datos").justify-content-center.align-items-center
        .col-lg-7.mb-4.mb-md-0
          p Seguidamente, se enfrenta el tema de las fuentes de datos y, como lo más común es que el <em>data warehouse</em> tenga distintas fuentes de datos, lo que obliga a todo el equipo a identificar por completo los almacenes de datos dedicados o centrados en el tema de negocio de la empresa, advirtiendo que la gama de posibilidades de esas fuentes es muy amplia, novedosa y tradicional; dentro de estas posibilidades, se destacan: 
          ul.lista-ul--color
            li.d-flex 
              i.fas.fa-circle.circle
              p.mb-0 Base de datos, tanto SQL como NoSQL.
            li.d-flex 
              i.fas.fa-circle.circle
              p.mb-0 Redes sociales.
            li.d-flex 
              i.fas.fa-circle.circle
              p.mb-0 Aplicativos <em>webs</em>, móviles, escritorio, etc.
            li.d-flex 
              i.fas.fa-circle.circle
      ...
      .row(titulo="Creación").justify-content-center.align-items-center
        .col-lg-7.mb-4.mb-md-0
          p En este momento, es el tiempo de crear el modelo de <em>data warehouse</em>, puesto que ya se establecieron todos los datos y las fuentes de dichos datos, haciendo énfasis en el modelo en estrella, que es el más importante y utilizado en estos casos. En este punto se hace necesario recomendar que se deben pasar la página de los modelos relacionales y sus implicaciones, como la integridad relacional; por ejemplo, si se quieren construir consultas eficientes de verdad, óptimas y eficaces, es inevitable repetir columnas (redundancia) que permitan la integración de distintas entidades (desnormalización), simplemente porque así lo demanda la situación, cuando la cantidad de datos es muy alta.

        .col-md-6.col-lg-5
          figure
            img(src='@/assets/curso/temas/tema4/img-6.png')
      .row(titulo="Proceso ETL").justify-content-center.align-items-center
        .col-lg-7.mb-4.mb-md-0
