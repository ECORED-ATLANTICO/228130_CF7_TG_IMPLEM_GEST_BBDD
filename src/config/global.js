export default {
  ...
  glosario: [
    {
      termino: 'API',
      significado:
        '<em>Application Programming Interface,</em> en español quiere decir interfaz de programación de aplicaciones.',
    },
    {
      termino: 'CRUD',
    ...
    },
    {
      termino: 'ERP',
      significado:
        '<em>Enterprise Resource Planning,</em> en español quiere decir sistema de planificación de recursos empresariales.',
    },
    {
      termino: 'ETL',
      significado:
        '<em>Extract, Transform, Load,</em> en español se traduce como extraer, transformar y cargar.',
    },
    {
      termino: 'JSON',
      significado:
        '<em>JavaScript Object Notation,</em> en español quiere decir notación de objetos de <em>JavaScript.</em>',
    },
    {
      termino: 'NoSQL',
  ...
  referencias: [
    ...
    {
      referencia:
        'Martínez, J. y Gallegos, A. (2017). <em>Programación de base de datos relacionales</em>. Ediciones de la U.',
    },
    {
      referencia:
        'Medina, J., Pineda, E. y Téllez, F. (2019). Requerimientos de <em>software</em>: prototipado, <em>software</em> heredado y análisis de documentos. <em>Ingeniería y Desarrollo, 37</em>(2).',
      link:
    ...
    {
      referencia: 'UNNE. (2018). <em>Ingeniería de software I</em>.',
      link:
    ...
    {
      referencia:
        'Wanumen, L., Rivas, E. y Mosquera, D. (2017). <em>Bases de datos en SQL Server</em>. Ecoe Ediciones.',
    },
  ],
  creditos: {
    liderEquipo: [
